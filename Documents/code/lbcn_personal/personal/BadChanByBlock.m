...
function bad_chan = BadChanByBlock(sbj,BN)
    ...
    case 'MMR'
        switch sbj
            ...
            case 'S13_47_JT2'
                switch BN
                    case 'JT2_01'
                        bad_chan = [1 32 31 29 97 30 95 64 85 5 63 3];
                    case 'JT2_03'
                        bad_chan = [1 32 31 29 97 30 95 64 85 5 63 3];
                end
            case 'S13_50_LGM'
            ...
            case 'S13_52_FVV'
                switch BN
                    case 'FVV_01'
                        bad_chan = [8 65 1 7 16 6 5 2 25 9 3 15 4 13 26 11 14 10 12 127 114 117 64];
                    case 'FVV_02'
                        bad_chan = [8 65 1 7 16 6 5 2 25 9 3 15 4 13 26 11 14 10 12 127 114 117 64 101];
                end                      
            case 'S13_53_KS2'
                switch BN
                    case 'KS2_02'
                        bad_chan = [104 65 98 112 117 111 110 108 107 106 105 127 109 73];
                    case 'KS2_03'
                        bad_chan = [104 65 98 112 117 111 110 108 107 106 105 127 109 73];
                end
            case 'S13_54_KDH'
            ...
            case 'S13_55_JJC'
                switch BN
                    case 'JJC_04'
                        bad_chan = [7 13 11 14 12];
                    case 'JJC_06'
                        bad_chan = [7 96 95 94 16 63 64 55 56];
            case 'S13_56_THS'
                BN = {'THS_07','THS_08'};
            case 'S13_57_TVD'
                switch BN
            ...
            case 'S18_130'
                switch BN
                    case 'E18-841_0005'
                        bad_chan = [30 21 5 6];
                    case 'E18-841_0008'
                        bad_chan = [7 8 90 5 6 21];
                    case 'E18-841_0009'
                        bad_chan = [22 30 86 21 7 23 5 6];
                    case 'E18-841_0015'
                        bad_chan = [30 50 91 21 23 5 6 24];
                end
